...
public class pregunta3 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jbtn_abir = new javax.swing.JButton();
        label_resultado = new javax.swing.JLabel();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);

        jbtn_abir.setText("Abrir");
        jbtn_abir.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jbtn_abirActionPerformed(evt);
            }
        });
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(label_resultado, javax.swing.GroupLayout.PREFERRED_SIZE, 297, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jbtn_abirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtn_abirActionPerformed
       int numero1 = (int) spinner1.getValue();
        int numero2 = (int) spinner2.getValue();
        int numero3 = (int) spinner3.getValue();

        if (numero1 == 2 && numero2 == 4 && numero3 == 6) {
            label_resultado.setText("Caja Abierta");
            label_resultado.setForeground(Color.BLUE);
        } else if (numero1 > 2 || numero2 > 4 || numero3 > 6) {
            label_resultado.setText("El número secreto es menor");
            label_resultado.setForeground(Color.RED);
        } else {
            label_resultado.setText("El número secreto es mayor");
            label_resultado.setForeground(Color.RED);
        }
    }//GEN-LAST:event_jbtn_abirActionPerformed
    ...
    private javax.swing.JButton jbtn_abir;
